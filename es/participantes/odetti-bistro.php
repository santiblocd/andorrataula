...
<html lang="es" class="ficha-restaurante">
  <head>
    ...
    <meta name="description" content="Descubre el menú gastronómico del restaurante Odetti Bistró para Andorra a Taula 2020 y degusta sus especialidades acompañadas de una cerveza INEDIT de Damm."/>
  </head>
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
            <div class="slide" style="background-image: url('../img/participants/odetti-bistro/01.jpg')"><div class="tipomenu">Menú gastronómico</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/odetti-bistro/06.jpg')"><span class="legal">INEDIT Damm recomienda el consumo responsable. Alc. 4,8º</span></div>
        </div>
        <!-- END IMÁGENES LINKS -->
