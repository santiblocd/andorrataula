  ...
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/restaurant-panxo/01.jpg')"><div class="tipomenu">Menú gastronómico</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/restaurant-panxo/05.jpg')"></div><div class="legal">INEDIT Damm recomienda el consumo responsable. Alc. 4,8º</div></div>
        </div>
        <!-- END IMÁGENES LINKS -->
