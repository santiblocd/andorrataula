    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          ...
          <div class="slide" style="background-image: url('../img/participants/restaurant-ca-la-conxita/05.jpg')"></div><div class="legal">INEDIT Damm recomienda el consumo responsable. Alc. 4,8º</div></div>
        </div>
        <!-- END IMÁGENES LINKS -->
