...
<html lang="es" class="ficha-restaurante">
  <head>
    ...
    <meta name="description" content="Descubre el menú gastronómico de la Pizzeria Restaurant Angelo La Massana para Andorra a Taula 2020 y degusta sus especialidades acompañadas de una cerveza INEDIT de Damm."/>
  </head>
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/pizzeria-restaurant-angelo-la-massana/01.jpg')"><div class="tipomenu">Menú gastronómico</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/pizzeria-restaurant-angelo-la-massana/05.jpg')"><span class="legal">INEDIT Damm recomienda el consumo responsable. Alc. 4,8º</span></div>
        </div>
        <!-- END IMÁGENES LINKS -->
