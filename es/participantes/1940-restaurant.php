...
<html lang="es" class="ficha-restaurante">
  <head>
    <meta charset="utf-8">
    <title>Andorra a Taula 2020 - 1940 Restaurant</title>
    <?php include dirname(__FILE__).'/../template-parts/head.html'; ?>
    <meta name="description" content="Descubre el menú tradicional de 1940 Restaurant para Andorra a Taula 2020 y degusta sus especialidades acompañadas de una cerveza INEDIT de Damm."/>
  </head>
  <body>
    ...
    <div data-barba="wrapper">
        ...
        <nav class="menu-lang">
          ...
          <li><a href="../participants/1940-restaurant.php">CA</a></li>
        </nav>
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/1940-restaurant/01.jpg')"><div class="tipomenu">Menú tradicional</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/1940-restaurant/05.jpg')"><span class="legal">INEDIT Damm recomienda el consumo responsable. Alc. 4,8º</span></div>
        </div>
        <!-- END IMÁGENES LINKS -->
