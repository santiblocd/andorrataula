...
<html lang="fr" class="ficha-restaurante">
  <head>
    ...
    <meta name="description" content="ADécouvrez le menu gastronomique du Restaurant Isard pour Andorra a Taula 2020 et dégustez ses spécialités accompagnées d'une bière INEDIT de Damm."/>
  ...
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/restaurant-isard/01.jpg')"><div class="tipomenu">Menu gastronomique</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/restaurant-isard/05.jpg')"><span class="legal">La bière INEDIT Damm est à consommer avec modération. 4,8o d’alcool</span></div>
        </div>
        <!-- END IMÁGENES LINKS -->
