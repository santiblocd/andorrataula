...
<html lang="fr" class="ficha-restaurante">
  <head>
    <meta charset="utf-8">
    <title>Andorra a Taula 2020 - Restaurant Ca la Conxita</title>
    <?php include dirname(__FILE__).'/../template-parts/head.html'; ?>
    <meta name="description" content="Découvrez le menu traditionnel du Restaurant Ca la Conxita pour Andorra a Taula 2020 et dégustez ses spécialités accompagnées d'une bière INEDIT de Damm."/>
  </head>
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="barra-left">
              ...
              <div class="info-menu">
                ...
                <div class="menu">
                  ...
                  <ul>
                    ...
                    —<br>
                    <li>Assortiment de pâtes aux quatre fromages<br> ou <br>Salade de tomate, mozzarella<br>et jambon de canard en sauce </li>
                    —<br>
                    <li>Poulpe à la plancha<br>garni de légumes à la sauce romesco<br> ou <br>Queue de bœuf à l’étouffée<br>garni de champignons</li>
                    —<br>
                ...
                <div class="menu">
                  ...
                  <ul>
                    ...
                    —<br>
                    <li>Macarrons maison la Conxita</li>
                    —<br>
          ...
          <div class="info-restaurant">
            <div class="direccion">
             ...
             <div class="boton">
              <a href="mailto:calaconxita@yahoo.es" target="_blank">Faites votre<br>réservation</a>
              <!-- SI ES UN MAIL PONER EN HREF MAILTO, EJEMPLO: <a href="mailto:xxxxxx@mail.com">Fes la teva <br>reserva</a>-->
            </div>
            <div class="direccion">
              <p>C. La Llacuna, 12 · Andorra la Vella</p>
              <p>(+376) 829 948</p>
              <p>Du lundi au dimanche, de 13.30 h à 15 h</p>
              <p>et de 20.30 h à 23 h</p>
              <p>Fermé le lundi et le dimanche soir</p>
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/restaurant-ca-la-conxita/01.jpg')"><div class="tipomenu">Menu traditionnel</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/restaurant-ca-la-conxita/05.jpg')"><span class="legal">La bière INEDIT Damm est à consommer avec modération. 4,8o d’alcool</span></div>
        </div>
        <!-- END IMÁGENES LINKS -->
