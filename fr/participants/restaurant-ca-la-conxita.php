  ...
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('../img/participants/restaurant-ca-la-conxita/01.jpg')"><div class="tipomenu">Menú Junior</div></div>
          ...
          <div class="slide" style="background-image: url('../img/participants/restaurant-ca-la-conxita/05.jpg')"></div>
        </div>
        <!-- END IMÁGENES LINKS -->
