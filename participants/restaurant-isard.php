...
<html lang="ca" class="ficha-restaurante">
  <head>
    ...
    <meta name="description" content="ADescobreix el menú gastronòmic del Restaurant Isard per a Andorra a Taula i assaboreix les seves especialitats acompanyades d’una cervesa INEDIT de Damm."/>
  </head>
  <body>
    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          <div class="slide" style="background-image: url('img/participants/restaurant-isard/01.jpg')"><div class="tipomenu">Menú gastronòmic</div></div>
          ...
          <div class="slide" style="background-image: url('img/participants/restaurant-isard/05.jpg')"><span class="legal">INEDIT Damm en recomana el consum responsable. Alc. 4,8º</span></div>
