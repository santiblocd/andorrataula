    ...
    <div data-barba="wrapper">
      ...
      <div class="restaurant" data-barba="container" data-barba-namespace="restaurant">
        ...
        <div class="gallery">
          ...
          <div class="slide" style="background-image: url('img/participants/restaurant-sol-i-neu-club-hermitage/06.jpg')"></div><div class="legal">INEDIT Damm en recomana el consum responsable. Alc. 4,8º</div></div>
        </div>
        <!-- END IMÁGENES LINKS -->
